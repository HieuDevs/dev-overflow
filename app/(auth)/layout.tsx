...
const AuthLayout = ({ children }: { children: React.ReactNode }) => {
  return (
    <main
      className="flex-center bg-auth min-h-screen 
    bg-cover bg-center bg-no-repeat px-4 py-10"
    >
      <section
        className="light-border background-light800_dark200 
      shadow-light min-w-full rounded-[10px] border px-4 py-10 
        ...
        <div className="flex-between gap-2">
          <div className="space-y-2.5">
            ...
            <p className="paragraph-regular text-dark500_light400">
              To get your answers faster, please enjoy a better experience.
            </p>
          </div>
          <Image
