...
const questionIdValidation = z.string().min(1, "Question ID is required");
const userIdValidation = z.string().min(1, "User ID is required");
...
export const AccountSchema = z.object({
  ...
  name: z.string().min(1, "Name is required"),
  image: z.string().url("Invalid image URL").optional(),
  password: strongPasswordValidation.optional(),
...
export const UpdateUserSchema = profileBaseSchema;
